export const Mockdata = {
  ...
  'programmes': {
    'good': {
      ...
      'possible_careers': ['Research Laboratories', 'Academia', 'Teaching'],
  ...
  'faculty': {
    ...
    'facTwo': [{
      ...
      'possible_careers': ['Management Consulting', 'Human Resources', 'Business Management', 'Small Business Management', 'Information Technology', 'Industrial Relations', 'Marketing', 'Operations Management', 'Finance', 'International Relations', 'Advertising and Public Relations'],
      'url': '',
    ...
    'facThree': [{
      ...
      'type': 'DOCTOR OF',
      'possible_careers': ['Public and Private Dental Hospitals or Clinics', 'Private Practice', 'Academia'],
